...
# Status codes indicating interesting finds
...
class DirectoryBruteforcer:
    ...
    def scan(self) -> List[Dict]:
        ...
        logger.info(f"[DIRBRUTE] Starting directory brute-force on {self.base_url}")

        # Calibrate: learn the 404 response size
        self._calibrate_404()
        ...
        if not words:
            ...
            generate_default_wordlist(wordlist_path, "directories")
            words = load_wordlist(wordlist_path)
    ...
    def _calibrate_404(self) -> None:
        """Send a request for a known-nonexistent path to learn 404 characteristics."""
        dummy = f"{self.base_url}/bughunterpro_nonexistent_calibration_page_xyz"
